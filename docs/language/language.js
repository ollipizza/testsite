 const language = {
    ...
    'openingHours': '每日營業時間為下午2點至晚上10點。',
'location': '地點',
    'address': '235新北市中和區和平街36號1 樓',
        'followUs': '關注我們',
        'rights': '© 2023 歐利披薩 保留所有權利。'
...
'english': {
    ...
    'orderNow': 'Order Now',
    'traditionPassion': 'Tradition &amp; Passion',
    ...
    'openingHours': 'Open daily from 14pm - 22pm',
    'location': 'Location',
    'address': '     Olli Pizza Bar <br> 235, New Taipei City, Zhonghe District, Heping St, 36號1 樓',
    'followUs': 'Follow Us',
'rights': '© 2023 Olli Pizza All rights reserved.',
